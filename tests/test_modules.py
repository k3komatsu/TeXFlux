...
class ImportFormTests(ModuleTestCase):
    ...
    def test_import_is_valid_in_a_value_position(self):
        ...
        # An imported value is one generated argument like any other, and its
        # braces are laid out the one way a generated brace is.
        self.assertEqual(self.build(), "\\pair{%\nA\n}{%\ntail\n}\n")
