...
## 15. 構文 AST と正準 AST（Syntax AST / Canonical AST）
...
## 16. 位置情報（SourceSpan）、ソースマップ、SyncTeX
...
## 17. エラー診断と旧構文からの移行（Diagnostics / Migration）
...
## 19. 受け入れテスト例（Acceptance examples）
